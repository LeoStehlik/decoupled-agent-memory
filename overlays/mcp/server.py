...
_mcp_url = urlparse(settings.MCP_URL)
_mcp_host = _mcp_url.hostname or "localhost"
_mcp_netloc = _mcp_url.netloc or _mcp_host
...
mcp = FastMCP(
    ...
    transport_security=TransportSecuritySettings(
        ...
        allowed_hosts=list(dict.fromkeys([_mcp_host, _mcp_netloc])),
    ),
)
